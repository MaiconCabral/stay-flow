...
export default function CadastroPage() {
  ...
  const canSubmit = name.trim() && email.trim() && password.trim() && confirmPassword.trim() && acceptTerms
  ...
  const inputClass = (field: string) =>
    `w-full px-3 py-2.5 rounded-lg bg-surface border text-sm text-text-primary placeholder:text-text-secondary outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-colors disabled:opacity-50 ${
    ...
    <div className="min-h-screen bg-surface flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-card rounded-2xl shadow-sm border border-border p-8">
        <div className="flex flex-col items-center text-center mb-8">
          ...
          <p className="text-sm text-text-secondary">Crie sua conta gratuita</p>
        </div>

        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-1.5">
            <label htmlFor="name" className="text-sm font-medium text-text-primary">Nome completo</label>
