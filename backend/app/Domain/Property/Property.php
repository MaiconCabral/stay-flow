...
class Property extends Model
{
    ...
    {
        static::created(fn (Property $property) => event(new PropertyCreated($property)));
        static::updated(fn (Property $property) => event(new PropertyUpdated($property, $property->getChanges())));
        static::deleted(fn (Property $property) => event(new PropertyDeleted($property)));
    }
}
